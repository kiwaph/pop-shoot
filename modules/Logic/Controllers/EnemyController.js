...
import { Controller } from "../../Actors/Enemies/Bosses/Controller.js";
...
import { Rider } from "../../Actors/Enemies/Bosses/Rider.js";
...
export class EnemyController {
    ...
    addEnemies() {
        ...
        // STAGE 4
        this.addEnemy(RedInvader, 905, 1190, 4);
        this.addEnemy(RedUfo, 910, 1190, 11);
        this.addEnemy(RedPlacer, 960, 1190, 30);
        this.addEnemy(RedEmperor, 990, 1190, 40);
        this.addEnemy(RedTerror, 1050, 1190, 35);
        this.addEnemy(Diver, 960, 1190, 60)
        this.addEnemy(BlackInvader, 1050, 1190, 20)
        this.addEnemy(YellowUfo, 1050, 1190, 14)
        // Boss
        this.addBoss(Controller, 1200);
        // Orange Package
    ...
    shouldSpawn(enemy) {
        ...
        const isInSlowmoSpawntime = game.state.time % (enemy.interval / game.state.variables.slowmorate) === 0 && game.state.slowmo;

        // Check for all conditions
        if (isInRange && isInState && (isInSpawnTime || isInSlowmoSpawntime))
            return true;
    }
}